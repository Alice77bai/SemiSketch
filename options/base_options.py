...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--checkpoints_dir', type=str, default='./pretrained_models', help='models are saved here')
        # model parameters
        parser.add_argument('--model', type=str, default='semi_cut', help='chooses which model to use.')
        ...
        parser.add_argument('--epoch', type=str, default='71', help='which epoch to load? set to latest to use latest cached model')
